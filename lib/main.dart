...
import 'package:niyi/pages/injury_details.dart';
import 'package:niyi/pages/instructions.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        'injury details': (context) => const InjuryDetailsScreen(),
        'instructions': (context) => FirstAidScreen(
              injuryType: '',
              description: '',
            )
      },
